/**
 * Mock for XRPL library in tests
 */
...
export const xrpToDrops = jest.fn((xrp) => (parseFloat(xrp) * 1000000).toString());

export const dropsToXrp = jest.fn((drops) => (parseFloat(drops) / 1000000).toString());